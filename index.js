...
mongoose.connect("mongodb+srv://WbSystem:wbsystem@cluster0-bj5fo.mongodb.net/test?retryWrites=true&w=majority",
 {useNewUrlParser: true,
    useUnifiedTopology: true});

app.use(express.static(__dirname + '/dist/WBSystem-ver2'));

app.get('/',(req, res)=>{
    res.sendFile(__dirname + '/dist/WBSystem-ver2/index.html');
});
